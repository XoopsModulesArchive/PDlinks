 ...
 * Licence: GNU
 */
require_once XOOPS_ROOT_PATH . '/modules/homenews/class/class.newsstory.php';
...
$newsModule = $moduleHandler->getByDirname('homenews');
$tags['STORY_URL'] = XOOPS_URL . '/modules/homenews/article.php?storyid=' . $story->storyid();
if (!empty($isnew)) {
