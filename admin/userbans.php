...
PDd_adminmenu(_AM_PDD2_EDITBANNED);
...
echo '<table class="outer">
		<tr><th align="center">' . _AM_PDD2_NONBANNED . '<br>';

echo '</th><th></th><th align="center">' . _AM_PDD2_BANNED . '<br>';
echo '</th></tr>
		<tr><td class="even">
...
echo "</td><td align='center' class='odd'>
		...
		<input type='submit' name='submit' value='" . _AM_PDD2_BADD . "'>
		</form><br>
		<form action='admin.php' method='post'>
		<input type='hidden' name='op' value='delUser'>
		<input type='hidden' name='fct' value='groups'>
		<input type='hidden' name='groupid' value='" . $thisgroup->getVar('groupid') . "'>
		<input type='submit' name='submit' value='" . _AM_PDD2_BDELETE . "'>
		</td>
		<td class='even'>";
